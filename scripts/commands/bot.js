...
module.exports = {
  ...
  start: async function ({ nayan, events, args, Users }) {
    try {
      ...
      if (!msg) {
        const greetings = ["- আমাকে বট বলবা না, আমাকে জান বলো 👀", "- ওই তোমার অলিতে গলিতে উম্মাহ দিমু-🙈", "- এইতো জান্স আমি এসে গেছি 🙋‍♀️", "- আমাকে এতো না ডেকে বস পাভেল কে একটা গফ দে 🙄", "- হুম কি বলবা তারাতাড়ি বলো 🤨", "- বট না বলে জামাই ডাকো 😒", "- আর একবার ডাক দিলে তোমার ওইখানে উম্মাহ-😶", "- আমি ইভানের আব্বু বলছি, আপনাকে কিভাবে সাহায্য করতে পারি 🐸", "- ডাক দিও না আমি চিপা খুজতে ব্যাস্ত 🙈", "- এত ডাকো কেন পমপম খাবা?", "- হুম প্রেম করবা? ", "হম জান্স হাংগা করবা?", "- ডাক দিও না আজকে আমার মন ভালো নাই 😔", "- বট ভট না করে পাভেল এর জন্য বউ খুজো 🌚", "- হম বেবি এইতো আমি এখানে 🙋‍♀️",  "- নাম ধরে ডাকো কেন?", "- বট না বলে ছেলে হলে দুলাভাই ডাক 🐸", "- হ্যাঁ বলো আমি শুনছি তো 😒"];
